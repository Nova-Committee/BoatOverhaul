...
public enum Sounds implements Sound {
    ...
    public static void init() {
        for (final Sound sound : Sounds.values())
            soundList.put(sound.getId(), RegistryHandler.SOUNDS.register(sound.getId(), () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(BoatOverhaul.MODID, sound.getId()))));
    }
