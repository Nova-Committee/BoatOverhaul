...
public class BoatOverhaulClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        config = Config.of("boatoverhaul-config").provider(_ ->
                """
        ...
        KeyMappingHelper.registerKeyMapping(Keys.keyLeftRudder);
        KeyMappingHelper.registerKeyMapping(Keys.keyRightRudder);
    }
